...
def main():
    ...
    Vote: https://snapshot.org/#/saddlefinance.eth/proposal/0x04a8a63ba3a55a0fbc14af28b02dac88f604484fa3b473085b9af1f261bb4984
    """
    ...
    if minichef.poolInfo(3)[2] != 3749:
        minichef.set(3, 3749, ZERO_ADDRESS, False)
    ...
    # Total allocation is 47.50% for Arbitrum
    assert minichef.totalAllocPoint() == 4750

    ##### Update reward rate

    new_rate = math.floor(
        SECOND_WEEK_HALVED_SIDECHAIN_TOTAL_EMISSION_RATE * 4750 / 10000
    )
