...
def main():
    ...
    gauge_data = {
        ...
        "SaddleFRAXWCUSDMetaPoolGauge": {
            "address": "0x3dC88ee38db8C7b6DCEB447E4348e51bd87ced93",
            "type": 0,
            "weight": 0,
        },
    }
    ...
    gauge_controller.add_gauge(
        gauge_data["SaddleFRAXWCUSDMetaPoolGauge"]["address"],
        gauge_data["SaddleFRAXWCUSDMetaPoolGauge"]["type"],
        gauge_data["SaddleFRAXWCUSDMetaPoolGauge"]["weight"],
    )
    ...
    gauge_to_relative_weight_dict = {
        ...
        "0x3dC88ee38db8C7b6DCEB447E4348e51bd87ced93": 0,  # Saddle FraxBP-WCUSD Metapool
    }
    ...
    sdl.transfer(
        SDL_MINTER_ADDRESS[CHAIN_IDS[TARGET_NETWORK]], amount_to_send_to_minter
    )
