...
def main():
    ...
    pools_to_future_a = {
        "0xa6018520EAACC06C30fF2e1B3ee2c7c22e64196a": 1000, # SaddleALETHPool
        "0xdf3309771d2BF82cb2B6C56F9f5365C8bD97c4f2": 2000, # SaddleBTCPoolV2
        "0xaCb83E0633d6605c5001e2Ab59EF3C745547C8C7": 3500, # SaddleUSDPoolV2
    }
    now = datetime.now()
    # @dev delta must be min 14 days. Add a couple days buffer for multisig to sign.
    now_plus_17_days = now + timedelta(days=17)
    now_plus_17_days_seconds = int((now_plus_17_days - datetime(1970, 1, 1)).total_seconds())
