...
def main():
    """
    Set Gauge weights for week 11_11_2022 -> 11_18_2022 from results of snapshot vote
    Vote: https://snapshot.org/#/saddlefinance.eth/proposal/0x47928d78d86791eb1718ccf46d0dc718d0dfac16b091e1e8ef6fb060853581fd
    """
    ...
    gauge_to_relative_weight_dict = {
        "0xB2Ac3382dA625eb41Fc803b57743f941a484e2a6": 7871,  # FRAXBP Pool
        "0xc64F8A9fe7BabecA66D3997C9d15558BF4817bE3": 137,  # Sushi SDL/WETH
        "0x953693DCB2E9DDC0c1398C1b540b81b63ceA5e16": 503,  # FraxBP-alUSD Metapool
        "0x104F44551386d603217450822443456229F73aE4": 503,  # FraxBP-sUSD Metapool
        "0x6EC5DD7D8E396973588f0dEFD79dCA04F844d57C": 99,  # FraxBP-USDT Metapool
        "0x13Ba45c2B686c6db7C2E28BD3a9E8EDd24B894eD": 99,  # Frax 3Pool
        "0x9585a54297beAa83F044866678b13d388D0180bf": 296,  # FraxBP-USX Metapool
        "0x702c1b8Ec3A77009D5898e18DA8F8959B6dF2093": 296,  # Saddle D4Pool
        ...
        "0x9980C9b35844946cF3451cC0B43D9b6501F4a96E": 197,  # Saddle FraxBP-VesperFrax Metapool
    }
    ...
    mainnet_minichef_debt = 202762e18  # 202761.41016412348410964 SDL is owed on mainnet
    ...
    sdl.transfer(MINICHEF_ADDRESSES[CHAIN_IDS["MAINNET"]], mainnet_minichef_debt)
    assert sdl_balance > sdl.balanceOf(
        MULTISIG_ADDRESSES[CHAIN_IDS["MAINNET"]]
    ), "SDL not sent to Mainnet Minichef"
